...
_Bool      nautilus_progress_info_get_is_started  (NautilusProgressInfo *info);
_Bool      nautilus_progress_info_get_is_finished (NautilusProgressInfo *info);
_Bool      nautilus_progress_info_get_is_paused   (NautilusProgressInfo *info);

void          nautilus_progress_info_queue           (NautilusProgressInfo *info);
