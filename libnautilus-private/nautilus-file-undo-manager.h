...
#define NAUTILUS_TYPE_FILE_UNDO_MANAGER (nautilus_file_undo_manager_get_type())
#define NAUTILUS_FILE_UNDO_MANAGER(object) (G_TYPE_CHECK_INSTANCE_CAST((object), NAUTILUS_TYPE_FILE_UNDO_MANAGER, NautilusFileUndoManager))
#define NAUTILUS_FILE_UNDO_MANAGER_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST((klass), NAUTILUS_TYPE_FILE_UNDO_MANAGER, NautilusFileUndoManagerClass))
#define NAUTILUS_IS_FILE_UNDO_MANAGER(object) (G_TYPE_CHECK_INSTANCE_TYPE((object), NAUTILUS_TYPE_FILE_UNDO_MANAGER))
#define NAUTILUS_IS_FILE_UNDO_MANAGER_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), NAUTILUS_TYPE_FILE_UNDO_MANAGER))
#define NAUTILUS_FILE_UNDO_MANAGER_GET_CLASS(object) (G_TYPE_INSTANCE_GET_CLASS((object), NAUTILUS_TYPE_FILE_UNDO_MANAGER, NautilusFileUndoManagerClass))
...
_Bool nautilus_file_undo_manager_pop_flag (void);
