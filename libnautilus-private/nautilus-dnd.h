...
typedef struct {
	...
	_Bool need_to_destroy;

	/* autoscrolling during dragging */
	int auto_scroll_timeout_id;
	_Bool waiting_to_autoscroll;
	signed long start_auto_scroll_in;
...
_Bool		    nautilus_drag_items_local			(const char			      *target_uri,
									 const GList			      *selection_list);
_Bool		    nautilus_drag_uris_local			(const char			      *target_uri,
									 const GList			      *source_uri_list);
_Bool		    nautilus_drag_items_in_trash		(const GList			      *selection_list);
_Bool		    nautilus_drag_items_on_desktop		(const GList			      *selection_list);
...
_Bool		    nautilus_drag_drag_data_get			(GtkWidget			      *widget,
...
_Bool		    nautilus_drag_autoscroll_in_scroll_region	(GtkWidget			      *widget);
...
_Bool		    nautilus_drag_selection_includes_special_link (GList			      *selection_list);
