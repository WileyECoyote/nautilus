...
typedef signed long  RequestCounter[REQUEST_TYPE_LAST];
...
struct NautilusDirectoryDetails
{
	...
	unsigned int call_ready_idle_id;

	NautilusMonitor *monitor;
	gulong 		 mime_db_monitor;

	_Bool in_async_service_loop;
	_Bool state_changed;

	_Bool file_list_monitored;
	_Bool directory_loaded;
	_Bool directory_loaded_sent_notification;
    ...
    unsigned int dequeue_pending_idle_id;
	...
	unsigned int             extension_info_idle;
...
void               nautilus_directory_call_when_ready_internal        (NautilusDirectory         *directory,
                                                                       ...
                                                                       void                      *callback_data);
_Bool              nautilus_directory_check_if_ready_internal         (NautilusDirectory         *directory,
                                                                       NautilusFile              *file,
                                                                       NautilusFileAttributes     file_attributes);
...
_Bool              nautilus_directory_is_file_list_monitored          (NautilusDirectory         *directory);
_Bool              nautilus_directory_is_anyone_monitoring_file_list  (NautilusDirectory         *directory);
_Bool              nautilus_directory_has_active_request_for_file     (NautilusDirectory         *directory,
                                                                       NautilusFile              *file);
