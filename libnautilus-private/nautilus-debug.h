...
typedef enum {
  ...
  NAUTILUS_DEBUG_ACTIONS = 1 << 15
} DebugFlags;

void nautilus_debug_set_flags (DebugFlags flags);
_Bool nautilus_debug_flag_is_set (DebugFlags flag);

void nautilus_debug_valist (DebugFlags flag, const char *format, va_list args);

void nautilus_debug (DebugFlags flag, const char *format, ...) G_GNUC_PRINTF (2, 3);
