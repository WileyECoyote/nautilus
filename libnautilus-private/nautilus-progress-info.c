...
struct _NautilusProgressInfo
{
	...
	_Bool start_at_idle;
	_Bool finish_at_idle;
	_Bool changed_at_idle;
	_Bool progress_at_idle;
    _Bool queue_at_idle;
};
...
static void
queue_idle (NautilusProgressInfo *info, _Bool now)
{
...
void
nautilus_progress_info_queue (NautilusProgressInfo *info)
{
    G_LOCK (progress_info);
