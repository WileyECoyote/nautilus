...
_Bool nautilus_drag_can_accept_item                   (NautilusFile *drop_target_item,
						     const char   *item_uri);
_Bool nautilus_drag_can_accept_items                  (NautilusFile *drop_target_item,
						     const GList  *items);
_Bool nautilus_drag_can_accept_info                   (NautilusFile *drop_target_item,
