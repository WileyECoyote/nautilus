...
_Bool         nautilus_link_local_create                        (const char        *directory_uri,
                                                                 ...
                                                                 int                screen,
                                                                _Bool               unique_filename);
_Bool         nautilus_link_local_set_text                      (const char        *uri,
                                                                 const char        *text);
_Bool         nautilus_link_local_set_icon                      (const char        *uri,
                                                                 const char        *icon);
