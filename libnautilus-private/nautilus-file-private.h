...
struct NautilusFileDetails
{
	...
	GError *get_info_error;
        ...
        unsigned int deep_directory_count;
        unsigned int deep_file_count;
        unsigned int deep_unreadable_count;
        unsigned int deep_hidden_count;
        goffset deep_size;
	...
	time_t          thumbnail_mtime;
        ...
        unsigned int    thumbnail_try_count;
...
void          nautilus_file_set_directory                  (NautilusFile           *file,
                                                            NautilusDirectory      *directory);
_Bool         nautilus_file_get_date                       (NautilusFile           *file,
 ...
 * new state.  */
_Bool         nautilus_file_update_info                    (NautilusFile           *file,
                                                            GFileInfo              *info);
_Bool         nautilus_file_update_name                    (NautilusFile           *file,
                                                            const char             *name);
_Bool         nautilus_file_update_metadata_from_info      (NautilusFile           *file,
                                                            GFileInfo              *info);

_Bool         nautilus_file_update_name_and_directory      (NautilusFile           *file,
                                                            const char             *name,
                                                            NautilusDirectory      *directory);

_Bool         nautilus_file_set_display_name               (NautilusFile           *file,
 ...
 */
_Bool         nautilus_file_should_get_top_left_text       (NautilusFile           *file);
...
_Bool                  nautilus_file_is_self_owned                      (NautilusFile           *file);
void                   nautilus_file_invalidate_count_and_mime_list     (NautilusFile           *file);
_Bool                  nautilus_file_rename_in_progress                 (NautilusFile           *file);
