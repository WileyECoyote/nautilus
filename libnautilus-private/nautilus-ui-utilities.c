...
static void
extension_action_callback (GtkAction *action, void *callback_data)
{
...
int
nautilus_ui_get_monitor_for_widget (GtkWidget *widget)
{
    ensure_screen ();
    ...
    return gdk_screen_get_monitor_at_window (default_screen, window);
}