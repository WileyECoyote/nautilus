...
#define NAUTILUS_ICON_CONTAINER(obj)            (G_TYPE_CHECK_INSTANCE_CAST ((obj), NAUTILUS_TYPE_ICON_CONTAINER, NautilusIconContainer))
#define NAUTILUS_ICON_CONTAINER_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST ((klass), NAUTILUS_TYPE_ICON_CONTAINER, NautilusIconContainerClass))
#define NAUTILUS_IS_ICON_CONTAINER(obj)         (G_TYPE_CHECK_INSTANCE_TYPE ((obj), NAUTILUS_TYPE_ICON_CONTAINER))
#define NAUTILUS_IS_ICON_CONTAINER_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE ((klass), NAUTILUS_TYPE_ICON_CONTAINER))
#define NAUTILUS_ICON_CONTAINER_GET_CLASS(obj)  (G_TYPE_INSTANCE_GET_CLASS ((obj), NAUTILUS_TYPE_ICON_CONTAINER, NautilusIconContainerClass))


#define NAUTILUS_ICON_CONTAINER_ICON_DATA(pointer) ((NautilusIconData *) (pointer))

typedef struct NautilusIconData NautilusIconData;

typedef void (* NautilusIconCallback) (NautilusIconData *icon_data,  void *callback_data);
...
typedef struct {
	 ...
	 */
	_Bool        (* can_accept_item)	  (NautilusIconContainer *container,
						   NautilusIconData *target,
						   const char *item_uri);
	_Bool        (* get_stored_icon_position) (NautilusIconContainer *container,
						   NautilusIconData *data,
	 ...
	 */
	_Bool        (* get_stored_layout_timestamp) (NautilusIconContainer *container,
						      NautilusIconData *data,
						      time_t *time);
	 ...
	 */
	_Bool        (* store_layout_timestamp) (NautilusIconContainer *container,
						 NautilusIconData *data,
						 const time_t *time);
	...
	_Bool        (* start_interactive_search) (NautilusIconContainer *container);
...
_Bool             nautilus_icon_container_add                           (NautilusIconContainer  *view,
                                                                         NautilusIconData       *data);
void              nautilus_icon_container_layout_now                    (NautilusIconContainer *container);
_Bool             nautilus_icon_container_remove                        (NautilusIconContainer  *view,
                                                                         NautilusIconData       *data);
...
void              nautilus_icon_container_reveal                        (NautilusIconContainer  *container,
                                                                         NautilusIconData       *data);
_Bool             nautilus_icon_container_is_empty                      (NautilusIconContainer  *container);
...
/* control the layout */
_Bool             nautilus_icon_container_is_auto_layout                (NautilusIconContainer  *container);
void              nautilus_icon_container_set_auto_layout               (NautilusIconContainer  *container,
                                                                         _Bool                   auto_layout);

_Bool             nautilus_icon_container_is_tighter_layout             (NautilusIconContainer  *container);
...
_Bool             nautilus_icon_container_is_keep_aligned               (NautilusIconContainer  *container);
...
_Bool             nautilus_icon_container_has_stretch_handles           (NautilusIconContainer  *container);
_Bool             nautilus_icon_container_is_stretched                  (NautilusIconContainer  *container);
...
void              nautilus_icon_container_enable_linger_selection       (NautilusIconContainer  *view,
                                                                         _Bool                   enable);
_Bool             nautilus_icon_container_get_is_fixed_size             (NautilusIconContainer  *container);
void              nautilus_icon_container_set_is_fixed_size             (NautilusIconContainer  *container,
                                                                         _Bool                   is_fixed_size);
_Bool             nautilus_icon_container_get_is_desktop                (NautilusIconContainer  *container);
void              nautilus_icon_container_set_is_desktop                (NautilusIconContainer  *container,
                                                                         _Bool                   is_desktop);
_Bool             nautilus_icon_container_get_show_desktop_tooltips     (NautilusIconContainer *container);
void              nautilus_icon_container_set_show_desktop_tooltips     (NautilusIconContainer *container,
                                                                              _Bool     show_tooltips);
...
char*             nautilus_icon_container_get_icon_description          (NautilusIconContainer  *container,
                                                                         NautilusIconData       *data);
_Bool             nautilus_icon_container_get_allow_moves               (NautilusIconContainer  *container);
...
_Bool   	  nautilus_icon_container_is_layout_rtl			(NautilusIconContainer  *container);
_Bool   	  nautilus_icon_container_is_layout_vertical		(NautilusIconContainer  *container);

_Bool             nautilus_icon_container_get_store_layout_timestamps   (NautilusIconContainer  *container);
...
void         nautilus_icon_container_setup_tooltip_preference_callback (NautilusIconContainer *container);
