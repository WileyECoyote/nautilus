 ...
 *
 * WEH: One might also note that this "hack" is the only declaration in this file
 * that references a local type, resulting in nearly every source file to include
 * multible headers before this file can be included.
 */
