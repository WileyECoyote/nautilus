...
#define NAUTILUS_DIRECTORY(obj)            (G_TYPE_CHECK_INSTANCE_CAST ((obj), NAUTILUS_TYPE_DIRECTORY, NautilusDirectory))
#define NAUTILUS_DIRECTORY_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST ((klass), NAUTILUS_TYPE_DIRECTORY, NautilusDirectoryClass))
#define NAUTILUS_IS_DIRECTORY(obj)         (G_TYPE_CHECK_INSTANCE_TYPE ((obj), NAUTILUS_TYPE_DIRECTORY))
#define NAUTILUS_IS_DIRECTORY_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE ((klass), NAUTILUS_TYPE_DIRECTORY))
#define NAUTILUS_DIRECTORY_GET_CLASS(obj)  (G_TYPE_INSTANCE_GET_CLASS ((obj), NAUTILUS_TYPE_DIRECTORY, NautilusDirectoryClass))

/* NautilusFile is defined here and in nautilus-file.h, nautilus-file-info.h. */
...
typedef struct
{
    ...
    /* The files_changed signal is emitted as changes occur to existing files
     * that are noticed by the synchronization framework, including when an old
     * file has been deleted. When an old file has been deleted, this is the
     * last chance to forget about these file objects, which are about to be
     * unref'd. Use a call to nautilus_file_is_gone () to test for this case.
     */
    ...
    _Bool    (* contains_file)       (NautilusDirectory        *directory,
                                      NautilusFile             *file);
    ...
    _Bool    (* are_all_files_seen)  (NautilusDirectory        *directory);
    _Bool    (* is_not_empty)        (NautilusDirectory        *directory);
     ...
     */
    _Bool    (* is_editable)         (NautilusDirectory *directory);
} NautilusDirectoryClass;

/* Basic GObject requirements. */
unsigned int       nautilus_directory_get_type                 (void);
...
_Bool              nautilus_directory_contains_file            (NautilusDirectory         *directory,
                                                                NautilusFile              *file);
 ...
 */
_Bool              nautilus_directory_is_not_empty             (NautilusDirectory         *directory);
_Bool              nautilus_directory_is_in_recent             (NautilusDirectory         *directory);
...
_Bool              nautilus_directory_is_desktop_directory     (NautilusDirectory         *directory);

_Bool              nautilus_directory_is_editable              (NautilusDirectory         *directory);
