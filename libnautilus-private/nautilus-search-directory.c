...
struct NautilusSearchDirectoryDetails {
	...
	_Bool search_running;
	_Bool search_finished;
...
static void search_callback_file_ready_callback (NautilusFile *file, void *data);
...
static void
start_or_stop_search_engine (NautilusSearchDirectory *search, _Bool adding)
{
...
static void
search_monitor_remove (NautilusDirectory *directory, const void *client)
{
	NautilusSearchDirectory *search;
	SearchMonitor *monitor;
	GList *list;
...
static void
cancel_call_when_ready (void *key, void *value, void *user_data)
{
...
static void
search_callback_file_ready_callback (NautilusFile *file, void *data)
{
...
static _Bool
search_contains_file (NautilusDirectory *directory, NautilusFile *file)
{
	NautilusSearchDirectory *search;
