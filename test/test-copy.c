...
static void
copy_done (GHashTable *debuting_uris, _Bool success, void * data)
{
	g_print ("Copy done\n");
}

static void
changed_cb (NautilusProgressInfo *info, void *data)
{
	g_print ("Changed: %s -- %s\n",
...
static void
finished_cb (NautilusProgressInfo *info, void *data)
{
	g_print ("Finished\n");
	gtk_main_quit ();
}
