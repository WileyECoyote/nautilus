...
struct _NautilusFileInfoIface
{
	...
	_Bool             (*is_gone)              (NautilusFileInfo *file);
	...
	_Bool             (*is_mime_type)         (NautilusFileInfo *file,
						   const char       *mime_Type);
	_Bool             (*is_directory)         (NautilusFileInfo *file);
	...
	_Bool             (*can_write)            (NautilusFileInfo *file);

};

GList            *nautilus_file_info_list_copy            (GList            *files);
void              nautilus_file_info_list_free            (GList            *files);
unsigned int      nautilus_file_info_get_type             (void);

/* Return true if the file has been deleted */
_Bool             nautilus_file_info_is_gone              (NautilusFileInfo *file);
...
_Bool             nautilus_file_info_is_mime_type         (NautilusFileInfo *file,
							   const char       *mime_type);
_Bool             nautilus_file_info_is_directory         (NautilusFileInfo *file);
_Bool             nautilus_file_info_can_write            (NautilusFileInfo *file);
