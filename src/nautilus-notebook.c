...
find_notebook_at_pointer (int abs_x, int abs_y)
{
...
static int
find_tab_num_at_pos (NautilusNotebook *notebook, int abs_x, int abs_y)
{
...
build_tab_label (NautilusNotebook *nb, NautilusWindowSlot *slot)
{
	...
	image = gtk_image_new_from_icon_name ("window-close-symbolic", STD_ICON_SIZE_MENU);
