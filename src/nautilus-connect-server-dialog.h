...
void nautilus_connect_server_dialog_display_location_async (NautilusConnectServerDialog *self,
							    ...
							    gpointer user_data);
_Bool nautilus_connect_server_dialog_display_location_finish (NautilusConnectServerDialog *self,
								 GAsyncResult *result,
								 GError **error);
...
void nautilus_connect_server_dialog_fill_details_async (NautilusConnectServerDialog *self,
							...
							GAsyncReadyCallback callback,
							gpointer user_data);
_Bool nautilus_connect_server_dialog_fill_details_finish (NautilusConnectServerDialog *self,
							     GAsyncResult *result);
