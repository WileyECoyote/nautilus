...
struct _NautilusWindowPane {
	...
	_Bool temporary_navigation_bar;
	_Bool temporary_search_bar;
...
unsigned int nautilus_window_pane_get_type (void);
...
void nautilus_window_pane_set_active                  (NautilusWindowPane *pane, _Bool is_active);
