...
struct NautilusWindowSlotClass {
  GtkBoxClass parent_class;
    ...
    void (* changed_pane)  (NautilusWindowSlot *slot);
};
...
struct NautilusWindowSlot {
	...
	unsigned int set_status_timeout_id;
	unsigned int loading_timeout_id;
	...
	_Bool viewed_file_seen;
	_Bool viewed_file_in_trash;
	...
	unsigned int location_change_distance;
...
_Bool nautilus_window_slot_should_close_with_mount (NautilusWindowSlot *slot,
						       GMount *mount);
