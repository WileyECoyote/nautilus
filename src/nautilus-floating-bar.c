...
#include <eel/eel-icons.h> /* for StdIconSize */
...
static int
nautilus_floating_bar_draw (GtkWidget *widget, cairo_t *cr)
{
...
GtkWidget *
nautilus_floating_bar_new (const char *label,
			   _Bool show_spinner)
{
				  ...
				  int action_id)
{
	...
	w = gtk_image_new_from_stock (stock_id, STD_ICON_SIZE_MENU);
	gtk_widget_show (w);
