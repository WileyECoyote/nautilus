...
static GList *nautilus_empty_view_get_selection_for_transfer      (NautilusView   *view);
...
static GList *
nautilus_empty_view_get_selection_for_transfer (NautilusView *view)
{
	return NULL;
}
...
nautilus_empty_view_class_init (NautilusEmptyViewClass *class)
{
	...
	nautilus_view_class->get_selection_for_transfer = nautilus_empty_view_get_selection_for_transfer;
