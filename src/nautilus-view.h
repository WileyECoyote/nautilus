...
#define NAUTILUS_VIEW_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST ((klass), NAUTILUS_TYPE_VIEW, NautilusViewClass))
#define NAUTILUS_IS_VIEW(obj)         (G_TYPE_CHECK_INSTANCE_TYPE ((obj), NAUTILUS_TYPE_VIEW))
#define NAUTILUS_IS_VIEW_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE ((klass), NAUTILUS_TYPE_VIEW))
#define NAUTILUS_VIEW_GET_CLASS(obj)  (G_TYPE_INSTANCE_GET_CLASS ((obj), NAUTILUS_TYPE_VIEW, NautilusViewClass))
...
struct NautilusViewClass {
	...
	/* get_selection_for_transfer  is a function pointer for
	 * subclasses to replace (override). Subclasses must replace it
	 * with a function that returns a newly-allocated GList of
	 ...
	 */
	GList *	(* get_selection_for_transfer)(NautilusView *view);
	...
	unsigned int (* get_item_count)          (NautilusView *view);

        /* bump_zoom_level is a function pointer that subclasses must
         * override to change the zoom level of an object. */
	...
	/* restore_default_zoom_level is a function pointer that subclasses must override
        ...
        NautilusZoomLevel  (* get_default_zoom_level)   (NautilusView *view);
        ...
        _Bool    (* can_zoom_in)	 	(NautilusView *view);
        ...
        _Bool    (* can_zoom_out)	 	(NautilusView *view);
	 ...
	 * view's lifecycle. */
	_Bool    (* using_manual_layout)     (NautilusView *view);
	 ...
	 * directory.
	 */
	_Bool    (* is_read_only)	        (NautilusView *view);

	/* is_empty is a function pointer that subclasses must
	 * override to report whether the view contains any items.
	 */
	_Bool    (* is_empty)                   (NautilusView *view);

	_Bool    (* can_rename_file)            (NautilusView *view,
						 NautilusFile *file);
	...
	void           (* scroll_to_file)	  (NautilusView          *view,
        ...
        _Bool    (* trash)                         (NautilusView *view);
        _Bool    (* delete)                        (NautilusView *view);
};
...
void              nautilus_view_action_copy                (GtkAction         *action,
                                                            NautilusView      *view);
void              nautilus_view_action_cut                 (GtkAction         *action,
                                                            NautilusView      *view);
void              nautilus_view_action_paste               (GtkAction         *action,
                                                            NautilusView      *view);
