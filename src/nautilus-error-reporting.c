...
static void finish_rename (NautilusFile *file, _Bool stop_timer, GError *error);
					 ...
					 GtkWindow *parent_window)
{
	...
	eel_show_error_dialog (_("<b>The folder contents could not be displayed.</b>"), message, NULL, parent_window);
				     ...
				     GtkWindow *parent_window)
{
	...
	eel_show_error_dialog (_("<b>The group could not be changed.</b>"), message, NULL, parent_window);
				     ...
				     GtkWindow *parent_window)
{
	...
	eel_show_error_dialog (_("<b>The owner could not be changed.</b>"), message, NULL, parent_window);
					   ...
					   GtkWindow *parent_window)
{
	...
	eel_show_error_dialog (_("<b>The permissions could not be changed.</b>"), message, NULL, parent_window);
				     ...
				     GtkWindow *parent_window)
{
	...
	eel_show_error_dialog (_("<b>The item could not be renamed.</b>"), message, NULL, parent_window);
...
static void
finish_rename (NautilusFile *file, _Bool stop_timer, GError *error)
{
	NautilusRenameData *data;
