...
#define PREVIEWER_DBUS_NAME "apps.nautilus.Preview"
#define PREVIEWER_DBUS_IFACE "apps.nautilus.Preview"
#define PREVIEWER_DBUS_PATH "/apps/nautilus/Preview"
...
nautilus_previewer_call_show_file (NautilusPreviewer *self,
                                   const gchar *uri,
                                   guint xid,
				   _Bool close_if_already_visible)
{
  GVariant *variant;
