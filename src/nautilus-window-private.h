...
struct NautilusWindowDetails
{
        GtkWidget *statusbar;
        GtkWidget *menubar;
        GtkWidget *nautilus_status_bar;

        GtkUIManager   *ui_manager;
        GtkActionGroup *main_action_group; /* owned by ui_manager */

        unsigned int help_message_cid;
        ...
        unsigned int          bookmarks_merge_id;
	...
	unsigned int short_list_merge_id;
	unsigned int extra_viewer_merge_id;

	/* Ensures that we do not react on signals of a
	 * view that is re-used as new view when its loading
	 * is cancelled
	 */
	_Bool temporarily_ignore_view_signals;
        ...
        unsigned int extensions_toolbar_merge_id;
        ...
        unsigned int sidebar_width_handler_id;

        unsigned int menu_state_changed_id;

        _Bool temporary_menu_bar;

        char *ignore_meta_view_id;
        int ignore_meta_zoom_level;
        GList *ignore_meta_visible_columns;
        GList *ignore_meta_column_order;
        char *ignore_meta_sort_column;
        int ignore_meta_sort_direction;
        int ignore_meta_tighter_layout;
};
