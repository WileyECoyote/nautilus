...
#define NAUTILUS_LIST_MODEL(obj)  (G_TYPE_CHECK_INSTANCE_CAST ((obj), NAUTILUS_TYPE_LIST_MODEL, NautilusListModel))
#define NAUTILUS_LIST_MODEL_CLASS(klass)  (G_TYPE_CHECK_CLASS_CAST ((klass), NAUTILUS_TYPE_LIST_MODEL, NautilusListModelClass))
#define NAUTILUS_IS_LIST_MODEL(obj)  (G_TYPE_CHECK_INSTANCE_TYPE ((obj), NAUTILUS_TYPE_LIST_MODEL))
#define NAUTILUS_IS_LIST_MODEL_CLASS(klass)  (G_TYPE_CHECK_CLASS_TYPE ((klass), NAUTILUS_TYPE_LIST_MODEL))
#define NAUTILUS_LIST_MODEL_GET_CLASS(obj)  (G_TYPE_INSTANCE_GET_CLASS ((obj), NAUTILUS_TYPE_LIST_MODEL, NautilusListModelClass))
...
unsigned int  nautilus_list_model_get_type                          (void);
_Bool         nautilus_list_model_add_file                          (NautilusListModel    *model,
                                                                     NautilusFile         *file,
                                                                     NautilusDirectory    *directory);
void          nautilus_list_model_file_changed                      (NautilusListModel    *model,
                                                                     NautilusFile         *file,
                                                                     NautilusDirectory    *directory);
_Bool         nautilus_list_model_is_empty                          (NautilusListModel    *model);
unsigned int  nautilus_list_model_get_length                        (NautilusListModel    *model);
...
GList        *nautilus_list_model_get_all_iters_for_file            (NautilusListModel    *model,
                                                                     NautilusFile         *file);
_Bool         nautilus_list_model_get_first_iter_for_file           (NautilusListModel    *model,
                                                                     NautilusFile         *file,
                                                                     GtkTreeIter          *iter);
...
NautilusFile     *nautilus_list_model_file_for_path                 (NautilusListModel  *model,
                                                                     GtkTreePath        *path);
_Bool             nautilus_list_model_load_subdirectory             (NautilusListModel  *model,
                                                                     GtkTreePath        *path,
                                                                     NautilusDirectory **directory);
void              nautilus_list_model_unload_subdirectory           (NautilusListModel  *model,
                                                                     GtkTreeIter        *iter);
