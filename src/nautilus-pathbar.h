...
struct _NautilusPathBar
{
	...
	int icon_size;
	signed short slider_width;
	signed short spacing;
	signed short button_offset;
	unsigned int timer;
	...
	_Bool drag_slider_timeout_for_up_button;
};
...
_Bool nautilus_path_bar_set_path    (NautilusPathBar *path_bar, GFile *file);
