...
#define FM_TREE_MODEL(obj)            (G_TYPE_CHECK_INSTANCE_CAST ((obj), FM_TYPE_TREE_MODEL, FMTreeModel))
#define FM_TREE_MODEL_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST ((klass), FM_TYPE_TREE_MODEL, FMTreeModelClass))
#define FM_IS_TREE_MODEL(obj)         (G_TYPE_CHECK_INSTANCE_TYPE ((obj), FM_TYPE_TREE_MODEL))
#define FM_IS_TREE_MODEL_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE ((klass), FM_TYPE_TREE_MODEL))
#define FM_TREE_MODEL_GET_CLASS(obj)  (G_TYPE_INSTANCE_GET_CLASS ((obj), FM_TYPE_TREE_MODEL, FMTreeModelClass))
...
unsigned int  fm_tree_model_get_type                  (void);
...
void          fm_tree_model_remove_root_uri           (FMTreeModel  *model,
                                                       const char   *root_uri);
_Bool         fm_tree_model_iter_is_root              (FMTreeModel  *model,
                                                       GtkTreeIter  *iter);
int           fm_tree_model_iter_compare_roots        (FMTreeModel  *model,
                                                       GtkTreeIter  *iter_a,
                                                       GtkTreeIter  *iter_b);
_Bool         fm_tree_model_file_get_iter             (FMTreeModel  *model,
                                                       GtkTreeIter  *iter,
                                                       NautilusFile *file,
                                                       GtkTreeIter  *currentIter);

GMount       *fm_tree_model_get_mount_for_root_node_file (FMTreeModel  *model,
                                                          NautilusFile *file);
