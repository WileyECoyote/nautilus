...
static int eel_canvas_button              (GtkWidget        *widget,
					    GdkEventButton   *event);
static int eel_canvas_motion              (GtkWidget        *widget,
					    GdkEventMotion   *event);
static int eel_canvas_draw                (GtkWidget        *widget,
                                            cairo_t          *cr);
static int eel_canvas_key                 (GtkWidget        *widget,
					    GdkEventKey      *event);
static int eel_canvas_crossing            (GtkWidget        *widget,
					    GdkEventCrossing *event);
static int eel_canvas_focus_in            (GtkWidget        *widget,
					    GdkEventFocus    *event);
static int eel_canvas_focus_out           (GtkWidget        *widget,
					    GdkEventFocus    *event);
...
static void
accessible_notify_cb (GObject *obj, GParamSpec *pspec)
{
...
{
  EEL_SOURCE_REMOVE_IF_THEN_ZERO(canvas->idle_id);
}
